...
import { GmgnRestClient } from './gmgn-rest-client.js';
import type { Chain } from './gmgn-rest-client.js';

export type { Chain } from './gmgn-rest-client.js';
export { GMGN_CHAINS } from './gmgn-rest-client.js';
...
export interface GMGNRawToken {
  ...
  sellTrade?: SellTrade;
  /** Optional deployer/creator address (EVM). When absent, the reputation read-path stays fail-closed neutral. */
  deployer?: string;
}
...
export class GMGNAdapter extends GmgnRestClient implements MarketDataProvider {
  readonly id = 'gmgn';
