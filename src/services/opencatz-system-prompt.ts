...
2. Multi-Agent Consensus Engine: Evaluates candidate signals through a 3-Layer Filter (Quant & Liquidity, Catalyst & Sentiment, Security Audit) requiring >= 80% Confidence Score.
3. 3 Specialist Screening Sub-Agents (24/7 Background Loops):
